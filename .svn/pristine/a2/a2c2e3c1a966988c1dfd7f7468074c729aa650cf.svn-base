...
public abstract class EthinkActivityRecog extends ActivityCommon implements IStatus {
...
//        StatusRecogListener listener = new MessageStatusRecogListener(handler);
        StatusRecogListener listener = new EthinkMessageRecogListener(handler);
    ...
    protected void start() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(EthinkActivityRecog.this);
